...
<div class="container">
    <div class="row justify-content-center">
        <div class="col-md-8">
            <h4 class="text-center mb-4">Record New Customer Cleaning Operation</h4>
            ...
            <div class="card">
                <div class="card-header">New Cleaning Record</div>
                <div class="card-body">
                    <form action="{{ route('cust_clean.store') }}" method="POST">
                        @csrf
                        ...
                        <div class="mb-3">
                            ...
                            <select class="form-select" id="cust_ali_id" name="cust_ali_id" required>
                                <option value="">Select a Customer Batch with Uncleaned Seeds</option>
                        ...
                        <div class="mb-3">
                            ...
                            <input type="number" step="0.01" class="form-control" id="makapi_kg" name="makapi_kg"
                                value="{{ old('makapi_kg', 0) }}" min="0" required>
                        ...
                        <div class="mb-3">
                            ...
                            <input type="text" class="form-control" id="cleaned_display" value="0.00" readonly>
                        ...
                        <button type="submit" class="btn btn-success">Record Cleaning</button>
