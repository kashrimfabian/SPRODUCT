...
<div class="container">
    <div class="row justify-content-center">
        <div class="col-md-8">
            <h4 class="text-center mb-4">Record New Customer Alizeti Input</h4>
            ...
            <div class="card">
                <div class="card-header">New Alizeti Input</div>
                <div class="card-body">
                    <form action="{{ route('cust_alizeti.store') }}" method="POST">
                        @csrf
                        ...
                        <div class="mb-3">
                            ...
                            <input type="text" class="form-control" id="batch_no" name="batch_no"
                                value="{{ old('batch_no') }}" required placeholder="e.g., CUST-A001">
                        ...
                        <div class="mb-3">
                            ...
                            <input type="number" step="0.01" class="form-control" id="uncleaned_kg"
                                name="uncleaned_kg" value="{{ old('uncleaned_kg') }}" min="0.01" required>
                        ...
                        <div class="mb-3">
                            ...
                            <select class="form-select" id="status" name="status" required>
                                ...
                                <option value="in_processing" {{ old('status') == 'in_processing' ? 'selected' : '' }}>In Processing</option>
                                <option value="processing_complete" {{ old('status') == 'processing_complete' ? 'selected' : '' }}>Processing Complete</option>
                                {{-- Add more statuses as needed --}}
                            </select>
                        </div>

                        <button type="submit" class="btn btn-success">Record Input</button>
