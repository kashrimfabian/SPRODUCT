...
<div class="container">
    <div class="row justify-content-center">
        <div class="col-md-8">
            <h4 class="text-center mb-4">Edit Uchekechaji (Cleaning) Operation</h4>
            ...
            <div class="card">
                <div class="card-header">Edit Uchekechaji Record (ID: {{ $uchekechaji->uchek_id }})</div>
                <div class="card-body">
                    <form action="{{ route('uchekechaji.update', $uchekechaji->uchek_id) }}" method="POST">
                        @csrf
                        ...
                        <div class="mb-3">
                            ...
                            <input type="date" class="form-control" id="tarehe" name="tarehe"
                                value="{{ old('tarehe', $uchekechaji->tarehe) }}" required>
                        </div>
                        ...
                        <div class="mb-3">
                            ...
                            <select class="form-select" id="alizeti_id" name="alizeti_id" required>
                                ...
                                <option value="{{ $batch->ali_id }}"
                                    {{ old('alizeti_id', $uchekechaji->alizeti_id) == $batch->ali_id ? 'selected' : '' }}>
                        ...
                        <div class="mb-3">
                            ...
                            <input type="number" step="0.01" class="form-control" id="uncleaned_amount" name="uncleaned_amount"
                                value="{{ old('uncleaned_amount', $uchekechaji->uncleaned_amount) }}" min="0.01" required>
                        </div>

                        <div class="mb-3">
                            <label for="makapi_amount" class="form-label">Makapi (Waste) Amount (kg)</label>
                            <input type="number" step="0.01" class="form-control" id="makapi_amount" name="makapi_amount"
                                value="{{ old('makapi_amount', $uchekechaji->makapi_amount) }}" min="0" required>
                        </div>

                        <div class="mb-3">
                            <label for="cleaned_amount_display" class="form-label">Cleaned Output (kg)</label>
                            <input type="text" class="form-control" id="cleaned_amount_display" value="{{ number_format(old('cleaned_amount', $uchekechaji->cleaned_amount), 2) }}" readonly>
                        ...
                        <div class="mb-3">
                            ...
                            <input type="number" step="0.01" class="form-control" id="initial_unit" name="initial_unit"
                                value="{{ old('initial_unit', $uchekechaji->initial_unit) }}" min="0">
                        ...
                        <div class="mb-3">
                            ...
                            <input type="number" step="0.01" class="form-control" id="final_unit" name="final_unit"
                                value="{{ old('final_unit', $uchekechaji->final_unit) }}" min="0">
                            
                        </div>
                        <div class="mb-3">
                            <label for="units_used_display" class="form-label">Units Used</label>
                            <input type="text" class="form-control" id="units_used_display" value="{{ number_format(old('units_used', $uchekechaji->units_used), 2) }}" readonly>
