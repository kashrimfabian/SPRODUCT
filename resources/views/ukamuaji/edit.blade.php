...
<div class="container">
    <div class="row justify-content-center">
        <div class="col-md-8">
            <h4 class="text-center mb-4">Edit Ukamuaji (Oil Pressing) Operation</h4>
            ...
            <div class="card">
                <div class="card-header">Edit Ukamuaji Record (ID: {{ $ukamuaji->uk_id }})</div>
                <div class="card-body">
                    <form action="{{ route('ukamuaji.update', $ukamuaji->uk_id) }}" method="POST">
                        @csrf
                        @method('PUT')
                        ...
                        <div class="mb-3">
                            ...
                            <select class="form-select" id="cust_ali_id" name="cust_ali_id" required>
                                ...
                                <option value="{{ $batch->cust_ali_id }}" 
                                    {{ old('cust_ali_id', $ukamuaji->cust_ali_id) == $batch->cust_ali_id ? 'selected' : '' }}
                        ...
                        <div class="mb-3">
                            ...
                            <select class="form-select" id="user_id" name="user_id" required>
                                ...
                                <option value="{{ $user->id }}" {{ old('user_id', $ukamuaji->user_id) == $user->id ? 'selected' : '' }}>
                        ...
                        <div class="mb-3">
                            ...
                            <input type="date" class="form-control" id="tarehe" name="tarehe"
                                value="{{ old('tarehe', $ukamuaji->tarehe) }}" required>
                        </div>
                        ...
                        <div class="mb-3">
                            ...
                            <input type="number" step="0.01" class="form-control" id="cleaned_kg"
                                name="cleaned_kg" value="{{ old('cleaned_kg', $ukamuaji->cleaned_kg) }}" min="0.01" required>
                        ...
                        <div class="mb-3">
                            ...
                            <input type="number" step="0.01" class="form-control" id="crude_oil" name="crude_oil"
                                value="{{ old('crude_oil', $ukamuaji->crude_oil) }}" min="0" required>
                        ...
                        <div class="mb-3">
                            ...
                            <input type="number" step="0.01" class="form-control" id="mashudu_kg" name="mashudu_kg"
                                value="{{ old('mashudu_kg', $ukamuaji->mashudu_kg) }}" min="0" required>
                        ...
                        <div class="mb-3">
                            ...
                            <input type="number" step="0.01" class="form-control" id="initial_units" name="initial_units"
                                value="{{ old('initial_units', $ukamuaji->initial_units) }}" min="0">
                        ...
                        <div class="mb-3">
                            ...
                            <input type="number" step="0.01" class="form-control" id="final_units" name="final_units"
                                value="{{ old('final_units', $ukamuaji->final_units) }}" min="0">
                        ...
                        <div class="mb-3">
                            ...
                            <input type="text" class="form-control" id="unit_used_display" value="{{ number_format(old('unit_used', $ukamuaji->unit_used), 2) }}" readonly>
                        </div>

                        <button type="submit" class="btn btn-success">Update Ukamuaji</button>
