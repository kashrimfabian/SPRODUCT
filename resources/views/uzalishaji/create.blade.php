...
<div class="container">
    <div class="card">
        <div class="card-body">
            <h1 class="card-title text-center mb-4">New Ukamuaji Records</h1>
            ...
            <form action="{{ route('uzalishaji.store') }}" method="POST">
                @csrf
                ...
                <div class="mb-3">
                    ...
                    <input type="number" name="mashudu" id="mashudu" class="form-control" min="1" value="{{ old('mashudu') }}" required>
                </div>
