...
<div class="container">
    <div class="row justify-content-center">
        <div class="col-md-8">
            <h4 class="text-center mb-4">Record New Oil Filtering Operation</h4>
            ...
            <div class="card">
                <div class="card-header">New Filtering Record</div>
                <div class="card-body">
                    <form action="{{ route('filtering.store') }}" method="POST"> {{-- Updated route name --}}
                        @csrf
                        ...
                        <div class="mb-3">
                            ...
                            <select class="form-select" id="cust_ali_id" name="cust_ali_id" required>
                                <option value="">Select a Customer Batch with Crude Oil</option>
                        ...
                        <div class="mb-3">
                            ...
                            <input type="number" step="0.01" class="form-control" id="crude_oil" name="crude_oil" {{-- Updated name --}}
                                value="{{ old('crude_oil') }}" min="0.01" required> {{-- Updated name --}}
                        ...
                        <div class="mb-3">
                            ...
                            <input type="number" step="0.01" class="form-control" id="refined_oil" name="refined_oil" {{-- Updated name --}}
                                value="{{ old('refined_oil', 0) }}" min="0" required> {{-- Updated name --}}
                        ...
                        <div class="mb-3">
                            ...
                            <input type="number" step="0.01" class="form-control" id="lami_kg" name="lami_kg" {{-- Updated name --}}
                                value="{{ old('lami_kg', 0) }}" min="0" required> {{-- Updated name --}}
                        ...
                        <div class="mb-3">
                            ...
                            <input type="number" step="0.01" class="form-control" id="ugido_kg" name="ugido_kg" {{-- Updated name --}}
                                value="{{ old('ugido_kg', 0) }}" min="0" required> {{-- Updated name --}}
                        ...
                        <div class="mb-3">
                            ...
                            <input type="number" step="0.01" class="form-control" id="cost_used" name="cost_used"
                                value="{{ old('cost_used', 0) }}" min="0" required>
                            <div class="form-text text-muted">Direct costs associated with this filtering operation.</div>
                        </div>

                        <button type="submit" class="btn btn-success">Record Filtering</button>
