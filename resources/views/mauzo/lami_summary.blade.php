...
<div class="container">
    ...
    <form action="{{ route('mauzo.lami_summary') }}" method="GET" class="row gx-2 gy-2 align-items-center mb-3">
        ...
        <div class="col-md-auto">
            ...
            <a href="{{ route('mauzo.lami_summary') }}" class="btn btn-secondary"><i class="fas fa-undo"></i> Reset</a>
        </div>
    </form>
        ...
        <table class="table table-striped table-bordered">
            ...
            <tbody>
                ...
                <tr>
                    ...
                    <td>{{ $sale->payment->method_name ?? 'N/A' }}</td>
                    <td>
