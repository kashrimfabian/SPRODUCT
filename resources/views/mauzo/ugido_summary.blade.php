...
<div class="container">
    ...
    <div class="collapse mb-4" id="filterCollapse">
        <div class="card card-body shadow-sm">
            <form action="{{ route('mauzo.ugido_summary') }}" method="GET">
                <div class="row g-3">
                    <div class="col-md-4">
                    ...
                    <div class="col-md-4">
                        ...
                        <select name="payment_id" id="payment_method_id" class="form-select">
                            ...
                            <option value="{{ $method->payment_id }}" {{ request('payment_id') == $method->payment_id ? 'selected' : '' }}>
                                {{ $method->name }} {{-- Displaying name, assuming 'name' is available on paymentMethods --}}
                            </option>
                            @endforeach
                        </select>
                    </div>
                    ...
                    <div class="col-12 d-flex justify-content-end gap-2">
                        ...
                        <a href="{{ route('mauzo.ugido_summary') }}" class="btn btn-warning"><i class="fas fa-undo"></i> Reset Filters</a>
                    </div>
                </div>
            </form>
        </div>
