...
<div class="container">
    ...
    <form action="{{ route('mauzo.ugido_summary') }}" method="GET" class="row gx-2 gy-2 align-items-center mb-3">
        ...
        <div class="col-md-auto">
            ...
            <a href="{{ route('mauzo.ugido_summary') }}" class="btn btn-secondary"><i class="fas fa-undo"></i> Reset</a>
        </div>
    </form>
