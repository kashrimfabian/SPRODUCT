    ...
    <aside id="sidebar" class="sidebar">
        <ul class="sidebar-nav" id="sidebar-nav">
            ...
            <li class="nav-item">
                ...
                <i class="fas fa-file-alt"></i><span>Reports</span><i class="bi bi-chevron-down ms-auto"></i>
                </a>
                @endif
            ...
            <li class="nav-item">
                <a class="nav-link collapsed" data-bs-target="#loans-nav" data-bs-toggle="collapse" href="#">
                    <i class="bi bi-receipt-cutoff"></i><span>uchekechaji</span><i
                        class="bi bi-chevron-down ms-auto"></i>
                </a>
                <ul id="loans-nav" class="nav-content collapse">
                    <li>
            ...
            <li class="nav-item">
                ...
                <ul id="debt-loans-nav" class="nav-content collapse">
                    <li>
